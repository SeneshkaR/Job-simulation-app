...
1. Get an API key from [MuleRun](https://mulerun.com/creator/studio) or [OpenAI](https://platform.openai.com/api-keys)
...
src/
  ...
  data/careers.js    — All 50 careers with colleagues, exercises, schedules, event pools
