...
// Gradients (array format for LinearGradient) shared across themes
const gradients = {
...
export const darkColors = {
  ...
  gradientBackground: ['#0F1023', '#1A1B2E', '#252742'],
};
...
export const lightColors = {
  ...
  overlayLight: 'rgba(26, 27, 46, 0.35)',
  border: '#E5E7EB',
  borderLight: '#F3F4F6',
  ...gradients,
  // Theme-specific gradients
  gradientDark: ['#EEF1F8', '#F8F9FD'],
  gradientCard: ['#FFFFFF', '#F1F3F9'],
  gradientBackground: ['#EEF1F8', '#F8F9FD', '#FFFFFF'],
};

// Default export kept for backward compatibility (dark theme)
