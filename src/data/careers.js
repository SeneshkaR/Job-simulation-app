  ...
  "quickTrial": {
    "lecture": {
      ...
      "sections": [
        {
          "type": "text",
          "content": "Software engineers do way more than just type code. About 40% of the day is talking with teammates, product managers, and designers."
        },
        {
          "type": "highlight",
          "content": "It's a team sport. You're constantly reviewing others' code and getting yours reviewed."
        },
        {
          "type": "myth-vs-reality",
          "myth": "You sit alone and code all day.",
          "reality": "You attend stand-ups, pair programming, code reviews, and design discussions."
        },
        {
          "type": "text",
          "content": "The best engineers aren't the fastest coders — they're the ones who ask smart questions and communicate clearly."
        }
      ],
      "durationMinutes": 5
    },
  ...
  "quickTrial": {
    "lecture": {
      ...
      "sections": [
        {
          "type": "text",
          "content": "Nurses are the eyes and ears of the hospital. You spot problems before they become emergencies."
        },
        {
          "type": "highlight",
          "content": "You will make 100+ small decisions every shift. Each one matters."
        },
        {
          "type": "myth-vs-reality",
...

{
  ...
  "quickTrial": {
    "lecture": {
      "title": "The Real Job of Civil Engineers",
      "sections": [
        {
          "type": "text",
          "content": "Civil engineers split time between office (CAD, meetings) and construction sites."
        },
        {
          "type": "myth-vs-reality",
          "myth": "You sit at a computer all day.",
          "reality": "You spend 30-50% of time on sites, meetings, coordinating."
        }
      ],
      "durationMinutes": 5
    },
  ...
  "quickTrial": {
    "lecture": {
      ...
      "sections": [
        {
          "type": "text",
          "content": "Digital marketing: 30% campaigns, 20% analytics, 20% content, 15% strategy."
        },
        {
          "type": "highlight",
          "content": "Most campaigns fail. Great marketers iterate fast."
        }
      ],
      "durationMinutes": 5
    },
...

{
  ...
  "quickTrial": {
    "lecture": {
      "title": "The Real Life of a Teacher",
      "sections": [
        {
          "type": "text",
          "content": "You arrive 6:30am to prep. Teach 6 classes. Handle 3 conflicts. Grade until 8pm."
        },
        {
          "type": "myth-vs-reality",
          "myth": "Teachers get summers off.",
          "reality": "Most spend summers on planning and training."
        }
      ],
      "durationMinutes": 5
    },
...

{
  ...
  "quickTrial": {
    "lecture": {
      "title": "Life as a Lawyer",
      "sections": [
        {
          "type": "text",
          "content": "Most lawyers spend 70% of time on research, drafting, and client calls. Court is rare."
        },
        {
          "type": "myth-vs-reality",
          "myth": "Lawyers argue in court all day.",
          "reality": "Most work is negotiation and writing."
        }
      ],
      "durationMinutes": 5
    },
  ...
  "quickTrial": {
    "lecture": {
      ...
      "sections": [
        {
          "type": "text",
          "content": "Not just tax returns. You advise on major decisions, catch fraud, forecast the future."
        }
      ],
      "durationMinutes": 5
    },
  ...
  "quickTrial": {
    "lecture": {
      ...
      "sections": [
        {
          "type": "text",
          "content": "70% of the job is cleaning data and building pipelines. ML modeling is maybe 20%."
        }
      ],
      "durationMinutes": 5
    },
...

{
  ...
  "quickTrial": {
    "lecture": {
      "title": "Beyond Talking",
      "sections": [
        {
          "type": "text",
          "content": "Therapy is structured. Every session has goals. You are not just listening — you are assessing."
        }
      ],
      "durationMinutes": 5
    },
...

{
  ...
  "quickTrial": {
    "lecture": {
      "title": "The Reality of Architecture",
      "sections": [
        {
          "type": "text",
          "content": "Only 10% of the job is sketching pretty buildings. The rest is codes, budgets, revisions."
        },
        {
          "type": "myth-vs-reality",
          "myth": "Architects design and it gets built.",
          "reality": "Every design gets cut and revised."
        }
      ],
      "durationMinutes": 5
    },
