...
import RegisteredTrialGuard from '../screens/RegisteredTrialGuard';
...
function RegisteredDayTrial(props) {
  return <RegisteredTrialGuard component={DayTrialScreen} {...props} />;
}

function RegisteredWeekTrial(props) {
  return <RegisteredTrialGuard component={WeekTrialScreen} {...props} />;
}
  ...
  return (
    <NavigationContainer>
      ...
      >
        ...
        {/* Explore guests can use Quick Trial; longer trials require a local account. */}
        <Stack.Screen name="TrialSelection" component={TrialSelectionScreen} />
        <Stack.Screen name="QuickTrial" component={QuickTrialScreen} />
        <Stack.Screen name="DayTrial" component={RegisteredDayTrial} />
        <Stack.Screen name="WeekTrial" component={RegisteredWeekTrial} />
